...
Возможно построение сектора цилиндра с использованием параметра angle.
     ...
     * @param shapes {Array} - Массив тел для разности.
     * @returns Shape
     */
    diff(a: Shape, b: Shape, shapes: Array): Shape;
     ...
     * @returns Shape
     */
    difference(a: Shape, b: Shape, shapes: Array): Shape;
...
Скругления задаются радиусом r и масcивом ближайших точек refs к модифицируемым ребрам/вершинам.
     ...
     * @param refs {Array} - Массив ближайших точек refs к ребрам или вершинам, подлежащим скруглению.
     * @returns Shape
     */
    fillet(shp: Shape, r: number, refs: Array): Shape;
     ...
     * @param a {Shape} - Тело 1.
     * @param b {Shape} - Тело 2.
     * @param shapes {Array} - Массив тел для пересечения.
     * @returns Shape
     */
    intersect(a: Shape, b: Shape, shapes: Array): Shape;
     ...
     * @param points {Array} - Массив вершин многоугольника.
     * @returns Shape
     */
    polygon(points: Array): Shape;
     ...
     * @param shapes {Array} - Массив тел для объединения
     * @returns Shape
     */
    unite(a: Shape, b: Shape, shapes: Array): Shape;
...
interface Point3 {
    /**
     * Описание метода.
     * @param argument {type} - Описание аргумента.
     * @returns {void}
     */
...
interface Rotor {
    ...
    * @type {Rotor.MiddleType}
    * @access Чтение\Запись
    */
     typeMiddleItem: Rotor.MiddleType;
};
...
interface Stator {
    ...
    * @type {Stator.MiddleType}
    * @access Чтение\Запись
    */
     typeMiddleItem: Stator.MiddleType;
    /**
...
interface Winding {
    ...
    * @type {Winding.LayerOrientation}
    * @access Чтение\Запись
    */
     layersOrientation: Winding.LayerOrientation;
    /**
